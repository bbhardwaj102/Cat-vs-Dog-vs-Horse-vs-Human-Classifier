...
for layer in custom_vgg_model.layers[:-1]:#all the layers should be freezed i.e. untrainable except last one which we have added i.e. softmax
	layer.trainable = False

custom_vgg_model.layers[3].trainable#for checking is it false or true
